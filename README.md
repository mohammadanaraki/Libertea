<img src="https://raw.githubusercontent.com/mohammadanaraki/Libertea/master/docs/logo-complete.png" style="width: 300px" />
...
1. Buy a domain and point its DNS to a CDN (such as Cloudflare), and set the CDN to `Full` SSL mode. [help](https://raw.githubusercontent.com/mohammadanaraki/Libertea/master/docs/cloudflare-full-ssl.png)
...
3. run the following command on your server and follow the instructions.
       ...
       curl -s https://raw.githubusercontent.com/mohammadanaraki/Libertea/master/bootstrap.sh -o /tmp/bootstrap.sh && bash /tmp/bootstrap.sh install
...
To update, just run the following command on your server:
    ...
    curl -s https://raw.githubusercontent.com/mohammadanaraki/Libertea/master/bootstrap.sh -o /tmp/bootstrap.sh && bash /tmp/bootstrap.sh update
...
If you want to uninstall Liberta or Liberta-secondary-proxy from your server for any reason, run the following command on your server:
    ...
    curl -s https://raw.githubusercontent.com/mohammadanaraki/Libertea/master/bootstrap.sh -o /tmp/bootstrap.sh && bash /tmp/bootstrap.sh uninstall
